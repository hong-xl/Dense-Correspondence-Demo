...
from densepose.vis.extractor import DensePoseOutputsExtractor, DensePoseResultExtractor, extract_boxes_xywh_from_instances, extract_scores_from_instances, CompoundExtractor
...
"""
all these functions are stolen from Denspose library with a little modifications, thanks. 
"""
...
def create_extractor(visualizer: object):
    ...
    """
    if isinstance(visualizer, DensePoseOutputsVertexVisualizer):
